                ...
                <div className="container">
                    ...
                    <ul className="ftr__list">
                        <li className="ftr__item">
                            <a className="ftr__link" href="#link">{Langs[lang].hdr.nav.link1}</a>
                        </li>

                        <li className="ftr__item">
                            <a className="ftr__link" href="#link">{Langs[lang].hdr.nav.link2}</a>
                        </li>

                        <li className="ftr__item">
                            <a className="ftr__link" href="#link">{Langs[lang].hdr.nav.link3}</a>
                        </li>
                    </ul>
